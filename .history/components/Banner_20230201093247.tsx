...
export default function Banner ({  netflixOriginals}: Props) {
    ...
    return (
        <div className='flex flex-col space-y-2 pt-24 pb-16 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12'>
            ...
            <p className=" max-w-xl text-xs text-shadow-md md:max-w-lg md:text-lg lg:max-w-2xl lg:text-2xl text-slate-200">
                {movie?.overview}
            </p>
